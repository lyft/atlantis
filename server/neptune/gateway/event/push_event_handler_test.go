...
func (d *mockDeploySignaler) SignalWithStartWorkflow(_ context.Context, _ *valid.MergedProjectCfg, _ models.Repo, _ string, _ int64, _ vcs.Ref, _ vcs.User, _ workflows.Trigger) (client.WorkflowRun, error) {
