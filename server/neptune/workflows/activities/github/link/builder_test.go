...
func Test_BuildDownloadLinkFromArchive(t *testing.T) {
	expectedURL := "https://github.com/testowner/testrepo/legacy.zip/refs/heads/main?archive=zip&token=testtoken123"
...
func Test_BuildDownloadLinkFromArchive_NoToken(t *testing.T) {
	expectedURL := "https://github.com/testowner/testrepo/legacy.zip/refs/heads/main?archive=zip"
	testRoot := terraform.Root{
		Path: "/test/path",
	}
	testRepo := github.Repo{
