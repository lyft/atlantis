...
func NewWorkflowStore(notifier UpdateNotifier, mode terraform.WorkflowMode, id string) *WorkflowStore {
	...
	return NewWorkflowStoreWithGenerator(notifier, urlGenerator, mode, id)
}
