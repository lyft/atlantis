...
func (mock *MockVersionedExecutorWorkflow) Run(ctx project.Context, executablePath string, envs map[string]string, workdir string, extraArgs []string) (string, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockVersionedExecutorWorkflow().")
	}
...
func (verifier *VerifierMockVersionedExecutorWorkflow) Run(ctx project.Context, executablePath string, envs map[string]string, workdir string, extraArgs []string) *MockVersionedExecutorWorkflow_Run_OngoingVerification {
	params := []pegomock.Param{ctx, executablePath, envs, workdir, extraArgs}
...
func (c *MockVersionedExecutorWorkflow_Run_OngoingVerification) GetCapturedArguments() (project.Context, string, map[string]string, string, []string) {
...
func (c *MockVersionedExecutorWorkflow_Run_OngoingVerification) GetAllCapturedArguments() (_param0 []project.Context, _param1 []string, _param2 []map[string]string, _param3 []string, _param4 [][]string) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
