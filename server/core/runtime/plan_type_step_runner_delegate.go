...
func (p NullRunner) Run(ctx project.Context, extraArgs []string, path string, envs map[string]string) (string, error) {
...
func (p RemoteBackendUnsupportedRunner) Run(ctx project.Context, extraArgs []string, path string, envs map[string]string) (string, error) {
...
func (p *PlanTypeStepRunnerDelegate) Run(ctx project.Context, extraArgs []string, path string, envs map[string]string) (string, error) {
