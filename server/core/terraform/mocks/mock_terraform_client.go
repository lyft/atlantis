...
func (c *MockClient_RunCommandWithVersion_OngoingVerification) GetCapturedArguments() (models.ProjectCommandContext, string, []string, map[string]string, *go_version.Version, string) {
