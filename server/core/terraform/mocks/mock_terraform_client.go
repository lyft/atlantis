...
func (mock *MockClient) RunCommandWithVersion(ctx project.Context, path string, args []string, envs map[string]string, v *go_version.Version, workspace string) (string, error) {
	if mock == nil {
...
func (c *MockClient_RunCommandWithVersion_OngoingVerification) GetCapturedArguments() (project.Context, string, []string, map[string]string, *go_version.Version, string) {
...
func (c *MockClient_RunCommandWithVersion_OngoingVerification) GetAllCapturedArguments() (_param0 []models.ProjectCommandContext, _param1 []string, _param2 [][]string, _param3 []map[string]string, _param4 []*go_version.Version, _param5 []string) {
