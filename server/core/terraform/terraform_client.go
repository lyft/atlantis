...
type Client interface {
	...
	RunCommandWithVersion(ctx project.Context, path string, args []string, envs map[string]string, v *version.Version, workspace string) (string, error)
...
func (c *DefaultClient) RunCommandWithVersion(ctx project.Context, path string, args []string, customEnvVars map[string]string, v *version.Version, workspace string) (string, error) {
