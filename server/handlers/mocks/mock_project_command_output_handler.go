...
func (mock *MockProjectCommandOutputHandler) Register(jobID string, receiver chan string) {
	...
	params := []pegomock.Param{jobID, receiver}
...
func (mock *MockProjectCommandOutputHandler) CleanUp(pullContext models.PullContext) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockProjectCommandOutputHandler().")
	}
	params := []pegomock.Param{pullContext}
...
func (verifier *VerifierMockProjectCommandOutputHandler) CleanUp(pullContext models.PullContext) *MockProjectCommandOutputHandler_CleanUp_OngoingVerification {
	params := []pegomock.Param{pullContext}
...
func (c *MockProjectCommandOutputHandler_CleanUp_OngoingVerification) GetCapturedArguments() models.PullContext {
	pullContext := c.GetAllCapturedArguments()
	return pullContext[len(pullContext)-1]
}

func (c *MockProjectCommandOutputHandler_CleanUp_OngoingVerification) GetAllCapturedArguments() (_param0 []models.PullContext) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
		_param0 = make([]models.PullContext, len(c.methodInvocations))
		for u, param := range params[0] {
			_param0[u] = param.(models.PullContext)
		}
	}
	return
}
