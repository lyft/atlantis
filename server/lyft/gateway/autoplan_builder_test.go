...
var autoplanBuilder gateway.AutoplanValidatorBuilder
...
func setupAutoplan(t *testing.T) *vcsmocks.MockClient {
	...
	autoplanBuilder = gateway.AutoplanValidatorBuilder{
		Logger:                        logger,
		Scope:                         scope,
		VCSClient:                     vcsClient,
...
func TestIsValid_DrainOngoing(t *testing.T) {
	...
	containsTerraformChanges := autoplanBuilder.IsValid(fixtures.GithubRepo, fixtures.GithubRepo, fixtures.Pull, fixtures.User)
