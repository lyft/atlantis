...
// Source: github.com/runatlantis/atlantis/server/legacy/core/runtime (interfaces: CustomRunner)
...
func NewMockCustomRunner(options ...pegomock.Option) *MockCustomRunner {
...
func (mock *MockCustomRunner) VerifyWasCalledOnce() *VerifierMockCustomRunner {
	return &VerifierMockCustomRunner{
		mock:                   mock,
		invocationCountMatcher: pegomock.Times(1),
	}
}

func (mock *MockCustomRunner) VerifyWasCalled(invocationCountMatcher pegomock.Matcher) *VerifierMockCustomRunner {
	return &VerifierMockCustomRunner{
		mock:                   mock,
...
func (mock *MockCustomRunner) VerifyWasCalledInOrder(invocationCountMatcher pegomock.Matcher, inOrderContext *pegomock.InOrderContext) *VerifierMockCustomRunner {
	return &VerifierMockCustomRunner{
		mock:                   mock,
		invocationCountMatcher: invocationCountMatcher,
...
func (mock *MockCustomRunner) VerifyWasCalledEventually(invocationCountMatcher pegomock.Matcher, timeout time.Duration) *VerifierMockCustomRunner {
	return &VerifierMockCustomRunner{
		mock:                   mock,
		invocationCountMatcher: invocationCountMatcher,
		timeout:                timeout,
...
type VerifierMockCustomRunner struct {
	mock                   *MockCustomRunner
...
type MockCustomRunner_Run_OngoingVerification struct {
	mock              *MockCustomRunner
