...
type ProjectCommandOutputHandler interface {
	...
	Send(ctx project.Context, msg string)
...
func (p *AsyncProjectCommandOutputHandler) Send(ctx project.Context, msg string) {
...
func (p *NoopProjectOutputHandler) Send(ctx project.Context, msg string) {
}
