...
// Source: github.com/runatlantis/atlantis/server/jobs/handlers (interfaces: ProjectCommandOutputHandler)
...
func (mock *MockProjectCommandOutputHandler) CleanUp(_param0 models0.PullContext) {
	if mock == nil {
...
func (verifier *VerifierMockProjectCommandOutputHandler) CleanUp(_param0 models0.PullContext) *MockProjectCommandOutputHandler_CleanUp_OngoingVerification {
	params := []pegomock.Param{_param0}
...
func (c *MockProjectCommandOutputHandler_CleanUp_OngoingVerification) GetCapturedArguments() models0.PullContext {
	_param0 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1]
}

func (c *MockProjectCommandOutputHandler_CleanUp_OngoingVerification) GetAllCapturedArguments() (_param0 []models0.PullContext) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
		_param0 = make([]models0.PullContext, len(c.methodInvocations))
		for u, param := range params[0] {
			_param0[u] = param.(models0.PullContext)
		}
	}
	return
}
