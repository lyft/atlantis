...
func (mock *MockProjectJobURLGenerator) GenerateProjectJobURL(_param0 project.Context) (string, error) {
	if mock == nil {
...
func (c *MockProjectJobURLGenerator_GenerateProjectJobURL_OngoingVerification) GetCapturedArguments() project.Context {
	_param0 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1]
}

func (c *MockProjectJobURLGenerator_GenerateProjectJobURL_OngoingVerification) GetAllCapturedArguments() (_param0 []project.Context) {
