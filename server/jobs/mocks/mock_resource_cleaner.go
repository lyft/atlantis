...
// Source: github.com/runatlantis/atlantis/server/jobs/handlers (interfaces: ResourceCleaner)
...
func (mock *MockResourceCleaner) CleanUp(_param0 models.PullContext) {
	if mock == nil {
...
func (verifier *VerifierMockResourceCleaner) CleanUp(_param0 models.PullContext) *MockResourceCleaner_CleanUp_OngoingVerification {
	params := []pegomock.Param{_param0}
...
func (c *MockResourceCleaner_CleanUp_OngoingVerification) GetCapturedArguments() models.PullContext {
	_param0 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1]
}

func (c *MockResourceCleaner_CleanUp_OngoingVerification) GetAllCapturedArguments() (_param0 []models.PullContext) {
