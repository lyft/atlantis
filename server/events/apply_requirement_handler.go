...
type ApplyRequirement interface {
	ValidateProject(repoDir string, ctx project.Context) (string, error)
}
...
func (a *AggregateApplyRequirements) ValidateProject(repoDir string, ctx project.Context) (failure string, err error) {
