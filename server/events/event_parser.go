...
type CommentCommand struct {
	...
	Verbose bool
	//Force is true of the command should ignore apply_requirments.
	Force bool
...
func NewCommentCommand(repoRelDir string, flags []string, name models.CommandName, verbose, force, autoMergeDisabled bool, workspace string, project string) *CommentCommand {
