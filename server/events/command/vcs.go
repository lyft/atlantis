...
func (d *VCSStatusUpdater) UpdateCombinedCount(ctx context.Context, repo models.Repo, pull models.PullRequest, status models.CommitStatus, cmdName fmt.Stringer, statusId string, numSuccess int, numTotal int) (string, error) {
	src := d.TitleBuilder.Build(cmdName.String())
	cmdVerb := "unknown"
