...
func (mock *MockApplyRequirement) ValidateProject(_param0 string, _param1 project.Context) (string, error) {
	if mock == nil {
...
func (verifier *VerifierMockApplyRequirement) ValidateProject(_param0 string, _param1 project.Context) *MockApplyRequirement_ValidateProject_OngoingVerification {
	params := []pegomock.Param{_param0, _param1}
...
func (c *MockApplyRequirement_ValidateProject_OngoingVerification) GetCapturedArguments() (string, project.Context) {
	_param0, _param1 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1], _param1[len(_param1)-1]
}

func (c *MockApplyRequirement_ValidateProject_OngoingVerification) GetAllCapturedArguments() (_param0 []string, _param1 []project.Context) {
	...
	if len(params) > 0 {
		...
		_param1 = make([]project.Context, len(c.methodInvocations))
		for u, param := range params[1] {
			_param1[u] = param.(project.Context)
		}
	}
	return
}
