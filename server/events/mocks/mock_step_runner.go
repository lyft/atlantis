...
func (mock *MockStepRunner) Run(ctx project.Context, extraArgs []string, path string, envs map[string]string) (string, error) {
	if mock == nil {
...
func (c *MockStepRunner_Run_OngoingVerification) GetCapturedArguments() (project.Context, []string, string, map[string]string) {
...
func (c *MockStepRunner_Run_OngoingVerification) GetAllCapturedArguments() (_param0 []project.Context, _param1 [][]string, _param2 []string, _param3 []map[string]string) {
