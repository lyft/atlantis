...
func (mock *MockStaleCommandChecker) CommandIsStale(ctx *models.CommandContext) bool {
	if mock == nil {
...
func (verifier *VerifierMockStaleCommandChecker) CommandIsStale(ctx *models.CommandContext) *MockStaleCommandChecker_CommandIsStale_OngoingVerification {
	params := []pegomock.Param{ctx}
...
func (c *MockStaleCommandChecker_CommandIsStale_OngoingVerification) GetCapturedArguments() *models.CommandContext {
	ctx := c.GetAllCapturedArguments()
	return ctx[len(ctx)-1]
}

func (c *MockStaleCommandChecker_CommandIsStale_OngoingVerification) GetAllCapturedArguments() (_param0 []*models.CommandContext) {
