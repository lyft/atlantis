...
func (mock *MockCommitStatusUpdater) CreateCommandStatus(_param0 context.Context, _param1 models.PullRequest, _param2 models.Repo, _param3 fmt.Stringer, _param4 models.CommitStatus) (string, error) {
	if mock == nil {
	...
	result := pegomock.GetGenericMockFrom(mock).Invoke("CreateCommandStatus", params, []reflect.Type{reflect.TypeOf((*string)(nil)).Elem(), reflect.TypeOf((*error)(nil)).Elem()})
	var ret0 string
	var ret1 error
	if len(result) != 0 {
		if result[0] != nil {
...
func (mock *MockCommitStatusUpdater) CreateProjectStatus(_param0 context.Context, _param1 command.ProjectContext, _param2 fmt.Stringer, _param3 models.CommitStatus) (string, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockCommitStatusUpdater().")
	}
	params := []pegomock.Param{_param0, _param1, _param2, _param3}
	result := pegomock.GetGenericMockFrom(mock).Invoke("CreateProjectStatus", params, []reflect.Type{reflect.TypeOf((*string)(nil)).Elem(), reflect.TypeOf((*error)(nil)).Elem()})
	var ret0 string
	var ret1 error
	if len(result) != 0 {
		if result[0] != nil {
...
func (mock *MockCommitStatusUpdater) UpdateCombined(_param0 context.Context, _param1 models.Repo, _param2 models.PullRequest, _param3 models.CommitStatus, _param4 fmt.Stringer, _param5 string) error {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockCommitStatusUpdater().")
	}
...
func (mock *MockCommitStatusUpdater) UpdateCombinedCount(_param0 context.Context, _param1 models.Repo, _param2 models.PullRequest, _param3 models.CommitStatus, _param4 fmt.Stringer, _param5 int, _param6 int, _param7 string) error {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockCommitStatusUpdater().")
	}
...
func (mock *MockCommitStatusUpdater) UpdateProject(_param0 context.Context, _param1 command.ProjectContext, _param2 fmt.Stringer, _param3 models.CommitStatus, _param4 string) error {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockCommitStatusUpdater().")
	}
	params := []pegomock.Param{_param0, _param1, _param2, _param3, _param4}
...
func (verifier *VerifierMockCommitStatusUpdater) CreateCommandStatus(_param0 context.Context, _param1 models.PullRequest, _param2 models.Repo, _param3 fmt.Stringer, _param4 models.CommitStatus) *MockCommitStatusUpdater_CreateCommandStatus_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2, _param3, _param4}
	methodInvocations := pegomock.GetGenericMockFrom(verifier.mock).Verify(verifier.inOrderContext, verifier.invocationCountMatcher, "CreateCommandStatus", params, verifier.timeout)
	return &MockCommitStatusUpdater_CreateCommandStatus_OngoingVerification{mock: verifier.mock, methodInvocations: methodInvocations}
}

type MockCommitStatusUpdater_CreateCommandStatus_OngoingVerification struct {
	mock              *MockCommitStatusUpdater
	methodInvocations []pegomock.MethodInvocation
}

func (c *MockCommitStatusUpdater_CreateCommandStatus_OngoingVerification) GetCapturedArguments() (context.Context, models.PullRequest, models.Repo, fmt.Stringer, models.CommitStatus) {
...
func (c *MockCommitStatusUpdater_CreateCommandStatus_OngoingVerification) GetAllCapturedArguments() (_param0 []context.Context, _param1 []models.PullRequest, _param2 []models.Repo, _param3 []fmt.Stringer, _param4 []models.CommitStatus) {
	...
	if len(params) > 0 {
		...
		_param3 = make([]fmt.Stringer, len(c.methodInvocations))
		for u, param := range params[3] {
			_param3[u] = param.(fmt.Stringer)
		}
		_param4 = make([]models.CommitStatus, len(c.methodInvocations))
		for u, param := range params[4] {
			_param4[u] = param.(models.CommitStatus)
		}
	}
	return
}

func (verifier *VerifierMockCommitStatusUpdater) CreateProjectStatus(_param0 context.Context, _param1 command.ProjectContext, _param2 fmt.Stringer, _param3 models.CommitStatus) *MockCommitStatusUpdater_CreateProjectStatus_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2, _param3}
	methodInvocations := pegomock.GetGenericMockFrom(verifier.mock).Verify(verifier.inOrderContext, verifier.invocationCountMatcher, "CreateProjectStatus", params, verifier.timeout)
	return &MockCommitStatusUpdater_CreateProjectStatus_OngoingVerification{mock: verifier.mock, methodInvocations: methodInvocations}
}

type MockCommitStatusUpdater_CreateProjectStatus_OngoingVerification struct {
	mock              *MockCommitStatusUpdater
	methodInvocations []pegomock.MethodInvocation
}

func (c *MockCommitStatusUpdater_CreateProjectStatus_OngoingVerification) GetCapturedArguments() (context.Context, command.ProjectContext, fmt.Stringer, models.CommitStatus) {
...
func (c *MockCommitStatusUpdater_CreateProjectStatus_OngoingVerification) GetAllCapturedArguments() (_param0 []context.Context, _param1 []command.ProjectContext, _param2 []fmt.Stringer, _param3 []models.CommitStatus) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
		_param0 = make([]context.Context, len(c.methodInvocations))
		for u, param := range params[0] {
...
func (verifier *VerifierMockCommitStatusUpdater) UpdateProject(_param0 context.Context, _param1 command.ProjectContext, _param2 fmt.Stringer, _param3 models.CommitStatus, _param4 string) *MockCommitStatusUpdater_UpdateProject_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2, _param3, _param4}
