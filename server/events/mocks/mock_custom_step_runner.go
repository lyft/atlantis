...
func (mock *MockCustomStepRunner) Run(ctx project.Context, cmd string, path string, envs map[string]string) (string, error) {
	if mock == nil {
...
func (verifier *VerifierMockCustomStepRunner) Run(ctx project.Context, cmd string, path string, envs map[string]string) *MockCustomStepRunner_Run_OngoingVerification {
	params := []pegomock.Param{ctx, cmd, path, envs}
...
func (c *MockCustomStepRunner_Run_OngoingVerification) GetCapturedArguments() (project.Context, string, string, map[string]string) {
	ctx, cmd, path, envs := c.GetAllCapturedArguments()
	return ctx[len(ctx)-1], cmd[len(cmd)-1], path[len(path)-1], envs[len(envs)-1]
}

func (c *MockCustomStepRunner_Run_OngoingVerification) GetAllCapturedArguments() (_param0 []project.Context, _param1 []string, _param2 []string, _param3 []map[string]string) {
