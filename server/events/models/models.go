...
type Repo struct {
	...
	FullName string
	// Owner is just the repo owner, ex. "runatlantis" or "subgroup"
...
type PullRequest struct {
	...
	BaseRepo Repo
	// HeadRepo is the repository that the pull request is merging from.
	HeadRepo Repo
...
//
//	subgroup/runatlantis/atlantis => (subgroup/runatlantis, atlantis)
