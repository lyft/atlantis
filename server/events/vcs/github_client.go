...
func (g *GithubClient) CreateStatus(ctx context.Context, request types.CreateStatusRequest) (string, error) {
	// TODO: Create github status check and return the status ID
