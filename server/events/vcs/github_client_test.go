...
func TestGithubClient_GetApprovalStatus(t *testing.T) {
	respTemplate := `[
		{
			"id": %d,
	...
	approved, err := client.GetApprovalStatus(models.Repo{
		FullName:          "owner/repo",
		Owner:             "owner",
		Name:              "repo",
		CloneURL:          "",
	...
	expected := models.ApprovalStatus{
		IsApproved: true,
		ApprovedBy: "octocat",
		Date:       timeOfApproval,
	}
	Equals(t, expected, approved)
}
